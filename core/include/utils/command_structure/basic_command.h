 ...
 *
 * @brief Basic Commands for Motors and Solenoids able to throw into the Command
 * Controller Commands Included
 *      - BasicSpinCommand
 *      - BasicStopCommand
 *      - BasicSolenoidSet
 *
 ...
 */
class BasicSpinCommand : public AutoCommandBase {
  public:
 ...
 * Using the Vex hardware functions
 */
class BasicStopCommand : public AutoCommandBase {
  public:
    /**
 ...
 * Using the Vex hardware functions
 */
class BasicSolenoidSet : public AutoCommandBase {
  public:
    /**
