...
class Flywheel {
   public:
     ...
     */
    Flywheel(vex::motor_group &motors, Feedback &feedback, FeedForward &helper,
             const double ratio, Filter &filt);
    ...
    /**
     * @brief Creates a new auto command that will hold until the flywheel has
