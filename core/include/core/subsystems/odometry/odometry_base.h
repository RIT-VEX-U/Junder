...
class OdometryBase {
   public:
    ...
    /**
     * Function that runs in the background task. This function pointer is
     * passed to the vex::task constructor.
     *
     ...
     * heading. Returns the difference between -180 degrees and +180 degrees,
     * representing the robot turning left or right, respectively.
   ...
   protected:
    ...
    double ang_accel_deg; /**< the rate at which we are accelerating our turn
                             (deg/s^2)*/
};