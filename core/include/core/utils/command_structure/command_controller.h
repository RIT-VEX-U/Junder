...
class CommandController {
  public:
     ...
     * @param timeout_seconds the number of seconds we will let the command run
     * for. If it exceeds this, we cancel it and run on_timeout. if it is <= 0
     * no time out will be applied
     */
    [[deprecated("Use list constructor instead. If you need to make a decision "
                 "before adding new commands, use Branch "
                 "(https://github.com/RIT-VEX-U/Core/wiki/"
                 "3-%7C-Utilites#commandcontroller)")]] void
