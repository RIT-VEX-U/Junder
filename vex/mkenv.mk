...
# compiler flags
CODE_QUALITY_FLAGS =-Wall -Wextra -Wpedantic -Wno-c99-extensions -Wno-c++17-extensions -Wno-c++14-extensions -Wdeprecated-declarations -Wno-keyword-macro -Wno-sign-compare -Wno-vla
CFLAGS_CL = ${CODE_QUALITY_FLAGS} -target thumbv7-none-eabi -fshort-enums -Wno-unknown-attributes -U__INT32_TYPE__ -U__UINT32_TYPE__ -D__INT32_TYPE__=long -D__UINT32_TYPE__='unsigned long' 
...
CXX_TIDY_CHECKS = readability-braces-around-statements
